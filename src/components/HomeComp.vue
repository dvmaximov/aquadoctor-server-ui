    ...
    <section class="slogan__left" ref="slogan__left">
      <div class="slogan-text slogan__item left1">
        ...
        <p class="slogan-text__content">
          ...
          рыбные тексты. Первую курсивных алфавит, знаках жаренные предупредила
          переулка имени путь реторический ipsum. Ты его буквенных если страну.
          Семантика lorem продолжил свой, правилами но своих повстречался меня
          пустился большого образ речью оксмокс подпоясал грустный большой
          вопрос злых последний пор. Свою, безопасную что.
        </p>
      </div>
