    ...
    <template v-slot:header="scope">
      <div class="row no-wrap items-center q-pa-sm q-gutter-xs">
        <q-btn
          ...
          flat
        >
          <q-tooltip>{{ $t('ClearFiles') }}</q-tooltip>
        </q-btn>
        <q-btn
          ...
          flat
        >
          <q-tooltip>{{ $t('DeleteDownloadedFiles') }}</q-tooltip>
        </q-btn>
        <q-spinner v-if="scope.isUploading" class="q-uploader__spinner" />
        <div class="col">
          <div class="q-uploader__title">{{ $t('UploadFile') }}</div>
        ...
        >
          ...
          <q-tooltip>{{ $t('SelectFile') }}</q-tooltip>
        </q-btn>
        <q-btn
          ...
          flat
        >
          <q-tooltip>{{ $t('UploadFile') }}</q-tooltip>
        </q-btn>
        ...
        <q-btn
          ...
          flat
        >
          <q-tooltip>{{ $t('AbortUpload') }}</q-tooltip>
        </q-btn>
      </div>
    </template>
  </q-uploader>
...
const rowClick = (evt: any, row: Musik, index: any) => {
  router.push({ name: 'musikedit', params: { id: row.id } });
};
</script>
